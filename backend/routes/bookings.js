...
// == HISTORIAL VIAJES ==
router.get('/viajes/historial', bookingController.obtenerHistorialViajesCompletoConAuth);
router.get('/viajes/activo', bookingController.obtenerViajeActivoCompletoConAuth);
